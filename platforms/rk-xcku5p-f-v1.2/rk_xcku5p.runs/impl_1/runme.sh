...
HD_PWD='/home/tommy/smolrv64/platforms/rk-xcku5p-f-v1.2/rk_xcku5p.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log rk_xcku5p.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source rk_xcku5p.tcl -notrace
