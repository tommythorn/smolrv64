...
set_max_delay -datapath_only 6.000 -from [get_clocks -of_objects [get_pins -hier -filter {NAME =~ *probe_clk_buf/O}]] -to   [get_pins -hier -filter {NAME =~ *probe_cdc/p_we_m_reg*/D || NAME =~ *probe_cdc/p_addr_m_reg*/D || NAME =~ *probe_cdc/p_wdata_m_reg*/D || NAME =~ *probe_cdc/p_wmask_m_reg*/D}]
set_property src_info {type:XDC file:1 line:266 export:INPUT save:INPUT read:READ} [current_design]
set_max_delay -datapath_only 6.000 -from [get_cells -hier -filter {NAME =~ *probe_cdc/m_rdata_q_reg*}] -to   [get_pins -hier -filter {NAME =~ *probe_cdc/p_rdata_reg*/D}]
