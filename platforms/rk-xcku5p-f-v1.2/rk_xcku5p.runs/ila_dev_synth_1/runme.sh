...
HD_PWD='/home/tommy/smolrv64/platforms/rk-xcku5p-f-v1.2/rk_xcku5p.runs/ila_dev_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ila_dev.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ila_dev.tcl
