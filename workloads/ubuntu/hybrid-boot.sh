...
echo "[fpga-boot] sending $DTB -> 0x$DTB_ADDR, $FW -> 0x$FW_ADDR, $INITRD -> 0x$INITRD_ADDR"
...
send_line "SL2800 d09e 80000000"

echo "[fpga-boot] launching when done: X${FW_ADDR} 0 ${DTB_ADDR}"
