...
module tb;
   ...
   initial begin
      ...
      rs2=0; rs2_v=0;
      chk(4'b0110, 8'h10, 4'b0000, 8'h00, 4'b0111);  // slot2->1, slot1->0
      ...
      rs2=0; rs2_v=0;
      chk(4'b1010, 8'h80, 4'b0000, 8'h00, 4'b0100); // slot3->2(10), slot1->0; mw only slot2

      // T5: youngest-earlier  s0:rd5, s1:rd5, s2.rs1=5 -> slot1
      rd={6'd0,6'd0,6'd5,6'd5}; rd_v=4'b0011;
      rs1={6'd0,6'd5,6'd0,6'd0}; rs1_v=4'b0100;
      rs2=0; rs2_v=0;
      chk(4'b0100, 8'h10, 4'b0000, 8'h00, 4'b0010); // slot2->1; mw only slot1
      ...
      rs2=0; rs2_v=0;
      chk(4'b0000, 8'h00, 4'b0000, 8'h00, 4'b0001);
