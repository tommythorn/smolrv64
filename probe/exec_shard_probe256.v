...
// Same exec_shard probe but with NPHYS=256 (PBITS=8, POOL=64, IDXB=6) to compare
// LUTRAM area / timing against the 128-register build. IN_W=460, OUT_W=140.
module probe_dut (input wire clk, input wire [459:0] din, output wire [139:0] dout);
   ...
   exec_shard #(.SHARDS(4), .SBITS(2), .NPHYS(256), .PBITS(8), .POOL(64), .IDXB(6)) dut
...
module exec_shard_probe256 (input wire clk, output wire probe_out);
