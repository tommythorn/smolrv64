...
module ooo2_rename
  #(parameter IDXB  = 7,
   ...
   wire [PW_I2-1:0] hc_i2_n = hc_i2 + {{(PW_I2-1){1'b0}}, cmt_i2} + {{(PW_I2-1){1'b0}}, cmt2_i2};
   ...
   always @(posedge clk) begin
      ...
      if (reset) begin
         ...
         t_i2 <= t_i2 + {{(PW_I2-1){1'b0}}, fre_i2} + {{(PW_I2-1){1'b0}}, fre2_i2};
         ...
         if (flush) begin
            ...
            h_i2 <= h_i2 + {{(PW_I2-1){1'b0}}, a_i2} + {{(PW_I2-1){1'b0}}, b_i2};
         end
      end
   end
